    ...
    >
      ...
      <main className="pb-24 pt-28 md:pt-32">
        ...
        <section className="mx-auto mt-24 w-[92%] max-w-[1080px] md:mt-32">
          <Tag>Our Story</Tag>
          <RevealText
            text={`We started Harmony because we have run services businesses ourselves. Too much of the day goes to work that could be automated, and the growth work that actually moves revenue keeps getting pushed back.

We tried the usual fixes. Every new hire became one more person to manage, and no tool we tried ever solved the problem completely.
