...
const categories: Category[] = [
  ...
  },
  {
    ...
    workflows: [
      ...
      { name: "Success", desc: "Watch health, prep touchpoints.", hue: "amber",
        inputs: ["Accounts", "Health", "Goals"], stages: [{ label: "Monitor", tools: ["hubspot", "salesforce"] }, { label: "Prep", tools: ["docs"] }],
        tierLabels: ["Champion", "Steady", "At Risk"], middles: ["Upsell", "Check-in", "Save"], outputs: ["Update", "Plan", "Alert"] },
      { name: "Renewals", desc: "Chase renewals before they slip.", hue: "teal",
        inputs: ["Contracts", "Dates", "Usage"], stages: [{ label: "Watch", tools: ["calendar"] }, { label: "Build", tools: ["docs"] }],
        tierLabels: ["90d", "60d", "30d"], middles: ["Notify", "QBR", "Offer"], outputs: ["Nudge", "Deck", "Quote"] },
    ],
  },
  {
    id: "sales-assistance",
